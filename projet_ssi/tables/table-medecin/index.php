...
$requet = $db->query("SET ROLE medecin"); 
$requet->fetch();
$requet  = $db->query("set default role medecin"); 
$requet->fetch();
...
?>
        ...
        <?php if(isset($_GET["s"])) : ?>
            <div class="alert alert-success rounded-lg w-80 mx-auto" style="margin-top:2em;margin-bottom:2em;">
        ...
        <tbody>
           <?php foreach($patients as $patient): ?>
            <tr>
                ...
                <th><a class="btn btn-primary btn-sm" href="/tables/table-medecin/acceder_patient.php?id=<?=$patient["id"]?>">Accéder</a> <a class="btn btn-warning btn-sm"href="/tables/table-medecin/update_patient.php?id=<?=$patient["id"]?>"> Mis a jour</a> <a class="btn btn-danger btn-sm"href="/tables/table-medecin/suppression_patient.php?id=<?=$patient["id"]?>" >Supprimer</a></th>
    ...
    <br>
    <div>
    <a type="button" class="btn btn-lg btn-success btn-block" href="/tables/table-medecin/ajouter_patient.php">Ajouter un patient </a>
    </div>
